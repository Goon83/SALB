...
extern struct PINT_server_req_params pvfs2_migrate_server_params;
extern struct PINT_server_req_params pvfs2_set_datafile_attr_server_params;
...
struct PINT_server_req_entry PINT_server_req_table[] =
{
    ...
    /* 39 */ {PVFS_SERV_MIGRATION_POSTER, &pvfs2_migrate_server_params},
    /* 40 */ {PVFS_SERV_SET_DF_ATTR_POSTER, &pvfs2_set_datafile_attr_server_params},
};
