...
struct PINT_server_migration_poster_op
{
    PVFS_handle handle;
    PVFS_fs_id fs_id; 
    ...
    PVFS_handle target_handle; /*migration target handle*/
};

struct PINT_server_mon_client_op
{
...
typedef struct PINT_server_op
{
	...
	struct PINT_server_mkdir_op mkdir;
        ...
        struct PINT_server_precreate_pool_refiller_op	precreate_pool_refiller;
        struct PINT_server_batch_create_op batch_create;
        struct PINT_server_batch_remove_op batch_remove;
	struct PINT_server_migration_poster_op migposter;
        struct PINT_server_mon_client_op monclient;
...
extern struct PINT_state_machine_s pvfs2_migrate_file_sm;
extern struct PINT_state_machine_s pvfs2_perf_mon_client_sm;
extern struct PINT_state_machine_s pvfs2_migrate_file_server_sm;
extern struct PINT_state_machine_s pvfs2_set_df_attr_client_sm;

/*global variable for perf mon client machine*/
extern struct PVFS_mgmt_perf_stat ** perf_load_matrix;
extern PVFS_BMI_addr_t * perf_load_addr_array;    
extern int io_server_count;
extern int perf_load_initialized;
extern PVFS_handle migrating_handle;
