...
static struct PINT_state_s ST_perm_check;
static struct PINT_pjmp_tbl_s ST_perm_check_pjtbl[];
static struct PINT_tran_tbl_s ST_perm_check_trtbl[];

static PINT_sm_action prelude_check_acls_if_needed(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_check_acls_if_needed;
static struct PINT_pjmp_tbl_s ST_check_acls_if_needed_pjtbl[];
static struct PINT_tran_tbl_s ST_check_acls_if_needed_trtbl[];
...
static struct PINT_tran_tbl_s ST_getattr_if_needed_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_perm_check }
};

static struct PINT_state_s ST_perm_check = {
	 .state_name = "perm_check" ,
	 .parent_machine = &pvfs2_prelude_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = prelude_perm_check ,
	 .pjtbl = NULL ,
	 .trtbl = ST_perm_check_trtbl 
};

static struct PINT_tran_tbl_s ST_perm_check_trtbl[] = {
	{ .return_value = PRELUDE_RUN_ACL_CHECKS ,
	 .next_state = &ST_check_acls_if_needed },
	{ .return_value = -1 ,
	 .flag = SM_RETURN }
};

static struct PINT_state_s ST_check_acls_if_needed = {
	 .state_name = "check_acls_if_needed" ,
	 .parent_machine = &pvfs2_prelude_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = prelude_check_acls_if_needed ,
	 .pjtbl = NULL ,
	 .trtbl = ST_check_acls_if_needed_trtbl 
};
...
static struct PINT_state_s ST_check_acls = {
	 ...
	 .parent_machine = &pvfs2_prelude_work_sm ,
	 .flag = SM_RUN ,
	 .action.func = prelude_check_acls ,
	 .pjtbl = NULL ,
    ...
    struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    /* if we didn't find the acl attributes, then just treat it as a
    ...
    /* anything else non-zero we treat as a real error */
    if (js_p->error_code)
    {
        goto cleanup;
    }
