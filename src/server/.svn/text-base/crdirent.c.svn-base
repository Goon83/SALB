...
static struct PINT_state_s ST_read_directory_entry_handle;
static struct PINT_pjmp_tbl_s ST_read_directory_entry_handle_pjtbl[];
static struct PINT_tran_tbl_s ST_read_directory_entry_handle_trtbl[];
...
static struct PINT_state_s ST_read_directory_entry_handle = {
	 ...
	 .parent_machine = &pvfs2_crdirent_sm ,
	 .flag = SM_RUN ,
	 .action.func = crdirent_read_directory_entry_handle ,
	 .pjtbl = NULL ,
	 .trtbl = ST_read_directory_entry_handle_trtbl 
};
