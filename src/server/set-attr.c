...
static struct PINT_state_s ST_get_datafile_count;
static struct PINT_pjmp_tbl_s ST_get_datafile_count_pjtbl[];
static struct PINT_tran_tbl_s ST_get_datafile_count_trtbl[];

static PINT_sm_action replace_datafile_handle_if_required(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_replace_datafile_handle_if_required;
static struct PINT_pjmp_tbl_s ST_replace_datafile_handle_if_required_pjtbl[];
static struct PINT_tran_tbl_s ST_replace_datafile_handle_if_required_trtbl[];

static PINT_sm_action replace_datafile_handle(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_replace_datafile_handle;
static struct PINT_pjmp_tbl_s ST_replace_datafile_handle_pjtbl[];
static struct PINT_tran_tbl_s ST_replace_datafile_handle_trtbl[];
...
static struct PINT_tran_tbl_s ST_verify_attribs_trtbl[] = {
	...
	{ .return_value = STATE_SINGLE_DATAFILE ,
	 .next_state = &ST_replace_datafile_handle_if_required },
	{ .return_value = 0 ,
...
static struct PINT_state_s ST_get_datafile_count = {
	 .state_name = "get_datafile_count" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = get_datafile_count ,
	 .pjtbl = NULL ,
	 .trtbl = ST_get_datafile_count_trtbl 
};
...
static struct PINT_state_s ST_replace_datafile_handle_if_required = {
	 .state_name = "replace_datafile_handle_if_required" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = replace_datafile_handle_if_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_replace_datafile_handle_if_required_trtbl 
};

static struct PINT_tran_tbl_s ST_replace_datafile_handle_if_required_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_replace_datafile_handle },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_replace_datafile_handle = {
	 .state_name = "replace_datafile_handle" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = replace_datafile_handle ,
	 .pjtbl = NULL ,
	 .trtbl = ST_replace_datafile_handle_trtbl 
};
