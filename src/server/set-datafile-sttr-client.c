...
static struct PINT_state_s ST_send_set_df_attr_request;
static struct PINT_pjmp_tbl_s ST_send_set_df_attr_request_pjtbl[];
static struct PINT_tran_tbl_s ST_send_set_df_attr_request_trtbl[];
static struct PINT_state_s ST_send_set_df_attr_request_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_send_set_df_attr_request_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_send_set_df_attr_request_xfer_msgpair_trtbl[];
...
struct PINT_state_machine_s pvfs2_set_df_attr_client_sm = {
	.name = "pvfs2_set_df_attr_client_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_set_df_attr_client_sm ,
	 .flag = SM_RUN ,
	 .action.func = init_set_df_attr_client ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_send_set_df_attr_request },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_send_set_df_attr_request = {
	 .state_name = "send_set_df_attr_request" ,
	 .parent_machine = &pvfs2_set_df_attr_client_sm ,
	 .flag = SM_RUN ,
	 .action.func = send_set_df_attr_request_op ,
	 .pjtbl = NULL ,
	 .trtbl = ST_send_set_df_attr_request_trtbl 
};

static struct PINT_tran_tbl_s ST_send_set_df_attr_request_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_send_set_df_attr_request_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_send_set_df_attr_request_xfer_msgpair = {
	 .state_name = "send_set_df_attr_request_xfer_msgpair" ,
	 .parent_machine = &pvfs2_set_df_attr_client_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_send_set_df_attr_request_xfer_msgpair_trtbl 
};
...
# 66 "src/server/set-datafile-sttr-client.sm"
