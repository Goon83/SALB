...
static struct PINT_state_s ST_perf_mon_client_init;
static struct PINT_pjmp_tbl_s ST_perf_mon_client_init_pjtbl[];
static struct PINT_tran_tbl_s ST_perf_mon_client_init_trtbl[];
...
struct PINT_state_machine_s pvfs2_perf_mon_client_sm = {
	.name = "pvfs2_perf_mon_client_sm",
	.first_state = &ST_perf_mon_client_init
};

static struct PINT_state_s ST_perf_mon_client_init = {
	 .state_name = "perf_mon_client_init" ,
	 .parent_machine = &pvfs2_perf_mon_client_sm ,
	 .flag = SM_RUN ,
	 .action.func = per_mon_client_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_perf_mon_client_init_trtbl 
};
...
static struct PINT_state_s ST_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_perf_mon_client_sm ,
	 .flag = SM_RUN ,
	 .action.func = perf_mon_client_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_perf_mon_client_sm ,
	 .flag = SM_RUN ,
	 .action.func = perf_mon_client_cleanup ,
	 .pjtbl = NULL ,
...
# 85 "src/server/per-mon-client.sm"
