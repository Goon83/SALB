...
/* added to count load of each data file */
struct  PINT_perf_counter_detail* PINT_server_pc_detail = NULL;


/* added to record global forecast load */
double global_forecast_load; 
 ...
 */
int    mig_state = 0; 
PVFS_handle  mig_datafile_handle;
double        load_diff = 0;
double        g_high_load  = 0;
double        g_low_load  = 0;
//int     migration_happen;
