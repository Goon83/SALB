...
# 100 "src/client/sysint/sys-readdirplus.sm"
    ...
    struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    for (i = 0; i < readdirplus_resp->pvfs_dirent_outcount; i++) 
    {
        if (readdirplus_resp->stat_err_array[i] == 0)
        {
            ...
            readdirplus_resp->attr_array[i].owner = sm_p->u.readdirplus.obj_attr_array[i].owner;
            readdirplus_resp->attr_array[i].group = sm_p->u.readdirplus.obj_attr_array[i].group;
            readdirplus_resp->attr_array[i].perms = sm_p->u.readdirplus.obj_attr_array[i].perms;
            readdirplus_resp->attr_array[i].atime = sm_p->u.readdirplus.obj_attr_array[i].atime;
            readdirplus_resp->attr_array[i].mtime = sm_p->u.readdirplus.obj_attr_array[i].mtime;
            readdirplus_resp->attr_array[i].ctime = sm_p->u.readdirplus.obj_attr_array[i].ctime;
            readdirplus_resp->attr_array[i].objtype = sm_p->u.readdirplus.obj_attr_array[i].objtype;
            readdirplus_resp->attr_array[i].mask =
                PVFS_util_object_to_sys_attr_mask(sm_p->u.readdirplus.obj_attr_array[i].mask);
            if (readdirplus_resp->attr_array[i].objtype == PVFS_TYPE_METAFILE)
            {
                if (sm_p->u.readdirplus.attrmask & PVFS_ATTR_META_DIST )
                {
                    ...
                    else
                    {
                        ...
                        readdirplus_resp->attr_array[i].size = sm_p->u.readdirplus.obj_attr_array[i].u.meta.stuffed_size;
                    }
                ...
                if (sm_p->u.readdirplus.attrmask & PVFS_ATTR_META_DFILES) 
                {
                    readdirplus_resp->attr_array[i].dfile_count = 
                        sm_p->u.readdirplus.obj_attr_array[i].u.meta.dfile_count;
                    readdirplus_resp->attr_array[i].mask |= PVFS_ATTR_SYS_DFILE_COUNT;
                }
            }
            else if (readdirplus_resp->attr_array[i].objtype == PVFS_TYPE_DIRECTORY)
            {
                ...
                readdirplus_resp->attr_array[i].mask |= PVFS_ATTR_SYS_DIRENT_COUNT;
            }
