	...
	switch (op_type) {
		...
		respsize = extra_size_PVFS_servresp_listeattr;
            ...
            case PVFS_SERV_LISTATTR:
                ...
                break;
            case PVFS_SERV_MIGRATION_POSTER:
		break;
	    case PVFS_SERV_SET_DF_ATTR_POSTER:
		break;
...
#define CASE(tag,var) \
	...
	CASE(PVFS_SERV_MIGRATION_POSTER,migposter);
	CASE(PVFS_SERV_SET_DF_ATTR_POSTER,set_df_attr_poster);
