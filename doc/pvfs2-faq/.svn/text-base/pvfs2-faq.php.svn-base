...
<LI><A NAME="tex2html105"
  HREF="pvfs2-faq.php#SECTION00020000000000000000">1 Basics</A>
<UL>
...
<LI><A NAME="tex2html154"
  HREF="pvfs2-faq.php#SECTION000619000000000000000">5.19 Does PVFS work with Open-MX?</A>
</UL>
<BR>
...
<SPAN CLASS="arabic">1</SPAN> Basics</A>
</H1>
...
<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">1</SPAN> What is PVFS?</A>
</H2>
...
<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">2</SPAN> What does the ``V'' in PVFS stand for?</A>
</H2>
...
<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">3</SPAN> Is PVFS an attempt to parallelize the *NIX VFS?</A>
</H2>
...
<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">4</SPAN> What are the components of PVFS that I should know about?</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">5</SPAN> What is the format of the PVFS version string?
</H2>
...
<SPAN CLASS="arabic">2</SPAN> Supported Architectures and Hardware</A>
</H1>
...
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">1</SPAN> Does PVFS require any particular hardware?</A>
</H2>
...
see Section&nbsp;<A HREF="#sec:fault-tolerance">7</A>.
...
<BR>
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">2</SPAN> What architectures does PVFS support?
</H2>
...
Question&nbsp;<A HREF="#sec:supported-hw">2.5</A> for more information on particular
hardware.
...
system.  Question&nbsp;<A HREF="#sec:kernel-version">2.4</A> covers this issue.

<P>

<H2><A NAME="SECTION00033000000000000000">
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">3</SPAN> Does PVFS work across heterogeneous architectures?</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">4</SPAN> Does running PVFS require a particular kernel or kernel
            version?
</H2>
...
<BR>
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">5</SPAN> What specific hardware architectures are supported by the
            PVFS kernel module?
</H2>
...
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">6</SPAN> Does the PVFS client require a patched Linux kernel?</A>
</H2>
...
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">7</SPAN> Can I build the PVFS kernel code directly into the kernel,
...
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">8</SPAN> Is there a MacOS X/Cygwin/Windows client for PVFS?</A>
</H2>
...
<SPAN CLASS="arabic">3</SPAN> Installation</A>
</H1>
...
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">1</SPAN> How do I install PVFS?</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">2</SPAN> How can I store PVFS data on multiple disks on a single node?
</H2>
...
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">3</SPAN> How can I run multiple PVFS servers on the same node?</A>
</H2>
...
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">4</SPAN> Can I use multiple metadata servers in PVFS?</A>
</H2>
...
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">5</SPAN> Does using multiple metadata servers reduce the chance of
...
Section&nbsp;<A HREF="#sec:fault-tolerance">7</A>.
...
<BR>
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">6</SPAN> How many servers should I run?
</H2>
...
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">7</SPAN> Can PVFS servers listen on two network interfaces simultaneously (i.e. multihome)?</A>
</H2>
...
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">8</SPAN> How can I automount PVFS volumes?</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">9</SPAN> Can I mount more than one PVFS file system on the same client?
</H2>
...
to edit the files a bit.  This editing needs to be performed <SPAN  CLASS="textit">before</SPAN> you
create the storage spaces!

<P>

<H2><A NAME="SECTION000410000000000000000">
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">10</SPAN> How can I upgrade from PVFS v1 to PVFS v2?</A>
</H2>
...
<SPAN CLASS="arabic">4</SPAN> Reporting Problems</A>
</H1>
...
<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">1</SPAN> Where can I find documentation?</A>
</H2>
...
<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">2</SPAN> What should I do if I have a problem?</A>
</H2>
...
<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">3</SPAN> How do I report a problem with PVFS?</A>
</H2>
...
<P>
<SPAN  CLASS="textit">Note:</SPAN> Please do not send your message to both the PVFS2 Users List and
...
<SPAN CLASS="arabic">5</SPAN> Problems and Solutions</A>
</H1>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">1</SPAN> When I try to mount, I get 'wrong fs type, bad option, bad
superblock...'</A>
</H2>
...
<A HREF="#sec:multiple-mounts">3.9</A>.
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">2</SPAN> PVFS server consumes 100% of the CPU
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">3</SPAN> PVFS write performance slows down dramatically
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">4</SPAN> I get ``error while loading shared libraries'' when starting PVFS programs</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">5</SPAN> PVFS performance gets really bad once a day, then gets
     better again
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">6</SPAN> Make kmod24 fails with ``structure has no member...'' errors</A>
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">7</SPAN> When i try to mount a pvfs2 file system, something goes wrong.</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">8</SPAN> I did all three of the above steps and I still can't mount pvfs2
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">9</SPAN> I'm running Redhat and the pvfs2-server can't be killed! What's wrong?</A>
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">10</SPAN> Why do you single out Redhat users?  What's so different
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">11</SPAN> Where is the kernel source on a Fedora system?</A>
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">12</SPAN> What are extended attributes? How do I use them with PVFS?</A>
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">13</SPAN> What are Access Control Lists? How do I enable Access Control Lists on PVFS?</A>
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">14</SPAN> On SLES 9, 'make kmod' complains about <TT>mmgrab</TT> and
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">15</SPAN> Everything built fine, but when I try to compile programs that use PVFS, I get undefined references
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">16</SPAN> Can we run the Apache webserver to serve files off a PVFS volume?</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">17</SPAN> Trove-dbpf metadata format version mismatch!
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">18</SPAN> Problems with pre-release kernels
</H2>
...
<H2><A NAME="SECTION000619000000000000000"></A>
<A NAME="sec:open-mx"></A>
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">19</SPAN> Does PVFS work with Open-MX?
</H2>
...
must set the ``MX_IMM_ACK'' environment variable to ``1'' before starting
...
<SPAN CLASS="arabic">6</SPAN> Performance</A>
</H1>
...
<BR>
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">1</SPAN> I configured PVFS with support for multiple intercdonnects (e.g. Infiniband and TCP), but see low performance
</H2>
...
<BR>
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">2</SPAN> I ran Bonnie and/or IOzone and the performance is terrible.
...
<BR>
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">3</SPAN> Why is program XXX so slow?
</H2>
See Question&nbsp;<A HREF="#sec:badperf">6.2</A>.  If the program uses small block sizes to
...
<BR>
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">4</SPAN> NFS outperforms PVFS for application XXX. Why?
</H2>
...
<BR>
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">5</SPAN> Can the underlying local file system affect PVFS performance?
</H2>
...
<BR>
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">6</SPAN> Is there any way to tune particular directories for different
workloads?
</H2>
...
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">1</SPAN> Distribution</A>
</H3>
...
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">2</SPAN> Distribution parameters</A>
</H3>
...
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">3</SPAN> Number of datafiles</A>
</H3>
...
<A NAME="sec:tuning"></A>
<BR>
<SPAN CLASS="arabic">6</SPAN>.<SPAN CLASS="arabic">7</SPAN> My app still runs more slowly than I would like.  What can I do?
</H2>
...
<LI>Are you running servers and clients on the same nodes?  We support this
      ...
      configuration.  See Section&nbsp;<A HREF="#sec:howmany-servers">3.6</A>. 
...
<BR>
<SPAN CLASS="arabic">7</SPAN> Fault Tolerance
</H1>
...
<SPAN CLASS="arabic">7</SPAN>.<SPAN CLASS="arabic">1</SPAN> Does PVFS support some form of fault tolerance?</A>
</H2>
...
<SPAN CLASS="arabic">7</SPAN>.<SPAN CLASS="arabic">2</SPAN> Can PVFS tolerate client failures?</A>
</H2>
...
<SPAN CLASS="arabic">7</SPAN>.<SPAN CLASS="arabic">3</SPAN> Can PVFS tolerate disk failures?</A>
</H2>
...
in the event of a disk failure.  See section <A HREF="#sec:multiple-disks">3.2</A> for more
information on this approach.

<P>

<H2><A NAME="SECTION00084000000000000000">
<SPAN CLASS="arabic">7</SPAN>.<SPAN CLASS="arabic">4</SPAN> Can PVFS tolerate network failures?</A>
</H2>
...
server may be used with PVFS.  <SPAN  CLASS="textit">Need a reference of some sort.</SPAN>

<P>

<H2><A NAME="SECTION00085000000000000000">
<SPAN CLASS="arabic">7</SPAN>.<SPAN CLASS="arabic">5</SPAN> Can PVFS tolerate server failures?</A>
</H2>
...
<SPAN CLASS="arabic">8</SPAN> File System Interfaces</A>
</H1>
...
<SPAN CLASS="arabic">8</SPAN>.<SPAN CLASS="arabic">1</SPAN> How do I get MPI-IO for PVFS?</A>
</H2>
...
<SPAN CLASS="arabic">8</SPAN>.<SPAN CLASS="arabic">2</SPAN> Can I directly manipulate PVFS files on the PVFS servers
...
<SPAN CLASS="arabic">9</SPAN> Management</A>
</H1>
...
<SPAN CLASS="arabic">9</SPAN>.<SPAN CLASS="arabic">1</SPAN> How can I back up my PVFS file system?</A>
</H2>
...
<SPAN CLASS="arabic">9</SPAN>.<SPAN CLASS="arabic">2</SPAN> Can I add, remove, or change the order of the PVFS servers
...
<P>
Note that adding a new server will <SPAN  CLASS="textit">not</SPAN> cause existing datafiles to be
...
Question&nbsp;<A HREF="#sec:migration">9.3</A>) both in the case of a new server, or if you
...
<BR>
<SPAN CLASS="arabic">9</SPAN>.<SPAN CLASS="arabic">3</SPAN> Are there tools for migrating data between servers?
</H2>
...
<BR>
<SPAN CLASS="arabic">9</SPAN>.<SPAN CLASS="arabic">4</SPAN> Why does df show less free space than I think it should? What
            can I do about that?
</H2>
...
<SPAN CLASS="arabic">9</SPAN>.<SPAN CLASS="arabic">5</SPAN> Does PVFS have a maximum file system size? If so, what is it?</A>
</H2>
...
<BR>
<SPAN CLASS="arabic">9</SPAN>.<SPAN CLASS="arabic">6</SPAN> Mouning PVFS with the interrupt option
</H2>
...
<SPAN CLASS="arabic">10</SPAN> Missing Features</A>
</H1>
...
<SPAN CLASS="arabic">10</SPAN>.<SPAN CLASS="arabic">1</SPAN> Why don't hardlinks work under PVFS?</A>
</H2>
...
<SPAN CLASS="arabic">10</SPAN>.<SPAN CLASS="arabic">2</SPAN> Can I <TT>mmap</TT> a PVFS file?</A>
</H2>
...
<SPAN CLASS="arabic">10</SPAN>.<SPAN CLASS="arabic">3</SPAN> Will PVFS store new files on servers with more space, allowing
...
Section&nbsp;<A HREF="#sec:contributing">11.1</A> for notes on how you could help get this
feature in place.

<P>

<H2><A NAME="SECTION000114000000000000000">
<SPAN CLASS="arabic">10</SPAN>.<SPAN CLASS="arabic">4</SPAN> Does PVFS have locks?</A>
</H2>
...
<SPAN CLASS="arabic">11</SPAN> Helping Out</A>
</H1>
...
<BR>
<SPAN CLASS="arabic">11</SPAN>.<SPAN CLASS="arabic">1</SPAN> How can I contribute to the PVFS project?
</H2>
...
<SPAN CLASS="arabic">12</SPAN> Implementation Details</A>
</H1>
...
<SPAN CLASS="arabic">12</SPAN>.<SPAN CLASS="arabic">1</SPAN> BMI</A>
</H2>
...
<SPAN CLASS="arabic">12</SPAN>.<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">1</SPAN> What is the maximum packet size for BMI?</A>
</H3>
...
<SPAN CLASS="arabic">12</SPAN>.<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">2</SPAN> What happens if I try to match a BMI send with a BMI receive
...
The command line arguments were: <BR>
 <STRONG>latex2html</STRONG> <TT>-split 0 -show_section_numbers -nonavigation -init_file /tmp/pvfs-2.8.2/doc/latex2html-init pvfs2-faq.tex</TT>
<P>
