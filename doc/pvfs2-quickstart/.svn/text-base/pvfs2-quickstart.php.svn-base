...
<LI><A NAME="tex2html31"
  HREF="pvfs2-quickstart.php#SECTION00020000000000000000">1 How to use this document</A>
<UL>
...
<A NAME="sec:howto"></A>
<BR>
<SPAN CLASS="arabic">1</SPAN> How to use this document
</H1>
...
<SPAN CLASS="arabic">1</SPAN>.<SPAN CLASS="arabic">1</SPAN> Versions</A>
</H2>
...
<SPAN CLASS="arabic">2</SPAN> Downloading and compiling PVFS2</A>
</H1>
...
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">1</SPAN> Dependencies</A>
</H2>
...
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">2</SPAN> Untarring the packages</A>
</H2>
...
<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">3</SPAN> Building and installing the packages</A>
</H2>
...
<UL>
<LI>-prefix=<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img1.png"
 ALT="$&lt;$"></SPAN>path<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img2.png"
 ALT="$&gt;$"></SPAN>: installs all files in the specified
directory (/usr/local/ is the default if -prefix is not specified)
</LI>
<LI>-with-kernel=<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img1.png"
 ALT="$&lt;$"></SPAN>path to 2.6.x kernel source<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img2.png"
 ALT="$&gt;$"></SPAN>: this enables
compilation of the PVFS2 Linux kernel driver [ Requires Linux Kernel
2.6.0 or later ]
</LI>
<LI>-with-kernel24=<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img1.png"
 ALT="$&lt;$"></SPAN>path to 2.4.x kernel source<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img2.png"
 ALT="$&gt;$"></SPAN>: this enables
compilation of the PVFS2 Linux kernel driver [ Requires Linux Kernel
...
<LI>-with-mpi=<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img1.png"
 ALT="$&lt;$"></SPAN>path to mpi installation<SPAN CLASS="MATH"><IMG
 WIDTH="18" HEIGHT="32" ALIGN="MIDDLE" BORDER="0"
 SRC="img2.png"
 ALT="$&gt;$"></SPAN>: this enables
...
<A NAME="sec:single"></A>
<BR>
<SPAN CLASS="arabic">3</SPAN> Configuring PVFS2 for a single host
</H1>
...
For this reason, we recommend that you <SPAN  CLASS="textit">not</SPAN> use ``localhost'' as 
...
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">2</SPAN> Starting the server</A>
</H2>
...
<A NAME="sec:rc"></A>
<BR>
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">2</SPAN>.<SPAN CLASS="arabic">1</SPAN> Automatic server startup and shutdown
</H3>
...
<BR>
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">3</SPAN> Client configuration
</H2>
...
<BR>
<SPAN CLASS="arabic">3</SPAN>.<SPAN CLASS="arabic">4</SPAN> Testing your installation
</H2>
...
<BR>
<SPAN CLASS="arabic">4</SPAN> Installing PVFS2 on a cluster
</H1>
...
<BR>
<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">1</SPAN> Server configuration
</H2>
...
machine, so familiarize yourself with Section <A HREF="#sec:single">3</A>.  We are going
...
<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">2</SPAN> Starting the servers</A>
</H2>
...
to the corresponding section <A HREF="#sec:rc">3.2.1</A> from the single server example.

<P>

<H2><A NAME="SECTION00053000000000000000">
<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">3</SPAN> Client configuration</A>
</H2>

<P>
Setting up a client for multiple servers is the same as setting up a client
for a single server.  Refer to section <A HREF="#subsec:client">3.3</A>.
...
<BR>
<SPAN CLASS="arabic">5</SPAN> The PVFS2 Linux Kernel Interface
</H1>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">1</SPAN> Finding an Appropriate Kernel Version
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">2</SPAN> Preparing Linux Kernel 2.6.x configurations
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">3</SPAN> Preparing Linux Kernel 2.4.x configurations
</H2>
...
<BR>
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">4</SPAN> Testing the Kernel Interface
</H2>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">1</SPAN> Loading the kernel module</A>
</H3>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">4</SPAN>.<SPAN CLASS="arabic">2</SPAN> Special Note for 2.4 kernels</A>
</H3>
...
<SPAN CLASS="arabic">5</SPAN>.<SPAN CLASS="arabic">5</SPAN> Unmounting and stopping PVFS2 on a client</A>
</H2>

<P>
While this is a quick <SPAN  CLASS="textit">start</SPAN> guide, knowing how to cleanly shut
...
network subsystem, and server state machines.  <SPAN  CLASS="textit">WARNING: this may
result in extremely large log files!</SPAN>  The logging masks can also be
...
The command line arguments were: <BR>
 <STRONG>latex2html</STRONG> <TT>-split 0 -show_section_numbers -nonavigation -init_file /tmp/pvfs-2.8.2/doc/latex2html-init pvfs2-quickstart.tex</TT>
<P>
